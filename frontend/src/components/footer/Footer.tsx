...
const Footer = () => {
  return (
    <>
    <Separator />
      <section className="bg-slate-100 py-10 sm:pt-16 lg:pt-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-x-8 gap-y-12 md:grid-cols-4 lg:grid-cols-12 xl:gap-x-12">
            <div className="col-span-2 md:col-span-4 xl:pr-8">
              ...
              <Link
                href="#"
                title=""
                className="mt-7 inline-flex items-center justify-center rounded-md bg-primary px-6 py-4 font-semibold text-white transition-all duration-200 hover:bg-primary focus:bg-primary"
              >
                <svg
                  className="h-6 w-6"
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <p className="text-sm text-gray-600">
              © Copyright 2021, All Rights Reserved by Vayu
            </p>
            ...
            <ul className="mt-5 flex items-center space-x-3 sm:mt-0 md:order-3">
              <li>
                <Link
                  href="#"
                  title=""
                  className="flex h-7 w-7 items-center justify-center rounded-full border border-gray-300 bg-transparent text-gray-800 transition-all duration-200 hover:border-orange-600 hover:bg-orange-600 hover:text-white focus:border-orange-600 focus:bg-orange-600 focus:text-white"
                >
                  <svg
                    className="h-4 w-4"
                    xmlns="http://www.w3.org/2000/svg"
